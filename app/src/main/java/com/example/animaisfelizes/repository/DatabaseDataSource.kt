...
class DatabaseDataSource(private val animalDAO: AnimalDAO): AnimalRepository {
    override suspend fun insertAnimal(nome: String, idade: Number, proprietario: String): Long {
    ...
    override suspend fun updateAnimal(id: Long, nome: String, idade: Number, proprietario: String) {
